 ...
 */
final class Bit_Connect_PurgeEditActivity extends Migration
{
    /**
    ...
    public function up(): void
    {
        ...
        // Ordering in InstallerProvider::migration() puts Bit_Connect_ActivityLog
        ...
        if ($result === false) {
            ...
            throw new RuntimeException(esc_html("Purging withdrawn activity actions failed: {$error}"));
        }
    }

    /**
     * Nothing to undo — the rows are gone, and inventing replacements would be
     * worse than the gap. Dropping the table is Bit_Connect_ActivityLog's job.
     */
