...
final class InstallerProvider
{
    ...
    {
        $migrations = [
            'BitAppsConnectPluginOptions',
            'BitAppsConnectVotes',
            'BitAppsConnectActivityLog',
            // After the table it reads, and last of the activity pair: it
            // deletes rows rather than shaping the schema.
            'BitAppsConnectPurgeEditActivity',
            'BitAppsConnectReports',
            'BitAppsConnectFollows',
            'BitAppsConnectNotifications',
        ];
