 ...
 *
 * What it is not is a control. Inert text rather than a button, because a
 * button in the exact spot the per-user editor occupies in the add-on would
 * read as the editor with a lock on it rather than as a column this plugin
 * reports and does not edit. The heading is the plain word Capabilities in
 * both editions: where the count comes from is the tooltip's job.
 *
